...
// Replace with real group invite link.
export const WHATSAPP_COMMUNITY_URL = 'https://chat.whatsapp.com/replace-this-link';

export const ADDRESS_LINE_1 =
  'New Link Rd, Near Lower Malad Metro Station';
export const ADDRESS_LINE_2 = 'Sunder Nagar, Malad West, Mumbai - 400064';
export const FULL_ADDRESS =
  'New Link Rd, Near Lower Malad Metro Station, Sunder Nagar, Malad West, Mumbai - 400064';
